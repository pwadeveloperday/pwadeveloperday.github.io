...
coverWidth: 16
coverHeight: 9
excerpt: "腾讯文档作为一款多人在线、跨平台的协作工具，积极拥抱 Web 生态，与 PWA 跨平台的特性强强联合，实现资源缓存控制、离线场景使用等等功能，只需维护一套代码实现多平台复用。同时在腾讯文档多品类多团队开发的基础之上，如何简易的接入并使用 PWA 也尤为重要，此次分享将为你揭秘腾讯文档 PWA 开发实践的那些事，让我们一起见证 PWA 技术为腾讯文档带来的更多的可能性。"
author: "彭伟宏"
authorTitle: "前端工程师"
authorCompany: "腾讯 PCG 平台与内容事业群"
authorImg: "/images/people/120/harry.png"
author2: ""
authorTitle2: ""
authorCompany2: ""
authorImg2: ""
...
<div class="det">
  彭伟宏是腾讯前端工程师，腾讯文档 PWA 模块 owner，目前主要负责腾讯文档
  PWA、表格的研发。
</div>
